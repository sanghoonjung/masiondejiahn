  ...
  return (
    <main>
      <section className="hero">
        <div className="eyebrow">A birthday dinner for her</div>
        <button className="brand" onMouseDown={startPress} onMouseUp={endPress} onMouseLeave={endPress} onTouchStart={startPress} onTouchEnd={endPress} aria-label="MAISON DE JIAHN">
          MAISON DE JIAHN
        </button>
        <p className="brand-korean">사랑하는 아내를 위한 한여름의 생일 저녁</p>
        <div className="hero-meta"><span>31 JULY</span><span>5 ADULTS · 1 LITTLE GUEST</span><span>WIRYE</span></div>
        <a className="scroll" href="#menu">Enter the birthday table ↓</a>
      </section>

      <section id="menu" className="section menu-section">
        <div className="section-label">The Menu</div>
        <h1>한 사람의 생일을 위해<br/>우리 가족의 여름을 담은 네 접시</h1>
      ...
      <section className="section story">
        <div className="section-label">For Her</div>
        <div className="story-grid">
          <h2>생일을 축하하는<br/>우리만의 방식.</h2>
          <p>사랑하는 아내의 생일을 위해, 우리 가족이 좋아하는 여름의 맛을 한 접시씩 담았습니다. 참외의 맑은 단맛에서 시작해 깻잎과 유자의 향을 지나, 따뜻한 라자냐와 오리로 이어지는 저녁입니다.</p>
        </div>
      </section>
      ...
      <section className="section invitation">
        ...
        <div className="invitation-grid">
          <div>
            <p className="invitation-kicker">Hosted by</p>
            <h2>우리 부부와 아들,
              <br/>그리고 세 분의 소중한 손님</h2>
          </div>
          <dl className="invitation-details">
            <div><dt>Date</dt><dd>2026년 7월 31일</dd></div>
            <div><dt>Table</dt><dd>호스트 2명 · 게스트 3명 · 아들 1명</dd></div>
            <div><dt>Venue</dt><dd>경기도 성남시 위례순환로 211<br/>(창곡동, 센트럴푸르지오)<br/>5408동 103호</dd></div>
          </dl>
        </div>
      </section>
      ...
      <section className="birthday-note">
        ...
        <p className="birthday-small">31 July · At Home</p>
        <h2>Happy Birthday, my love.</h2>
        <p>우리 집에서 함께 맞는 또 하나의 여름.</p>
      </section>
        ...
        <section className="chef-panel">
          <div className="chef-header">
            <div>
              ...
              <h2>Birthday Kitchen Runbook</h2>
            </div>
      ...
      <footer>
        <button onClick={() => setChef(v => !v)}>{chef ? 'Exit chef mode' : 'MAISON DE JIAHN · 2026'}</button>
      </footer>
    </main>
  );
}
